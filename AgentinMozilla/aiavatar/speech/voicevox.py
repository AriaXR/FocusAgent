...
class GoogleTTS(SpeechController):
    def __init__(self, api_key: str , device_index: int=-1, lang = 'en-US'):
    ...
    async def tts(self, voice: VoiceClip):
        ...
        client = texttospeech.TextToSpeechClient(client_options={"api_key": self.api_key})
    ...
    def prefetch(self, text: str):
        ...
        if v:
            return v
        v = VoiceClip(text)
        v.download_task = asyncio.create_task(self.tts(v))
